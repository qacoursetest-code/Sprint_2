...
class Football(Results):
    ...
    # ИИ подсказало что если конструктор ничего нового не делает, Python автоматически возьмет его у родителя, поэтому можно его не писать в дочернем классе
...
# здесь полиморфизм через цикл for: сначала team == footbal_team, затем team = hockey_team
